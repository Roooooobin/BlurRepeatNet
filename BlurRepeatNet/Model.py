...
import torch
from TrainerUtils.BilinearAttention import *
...
class BlurRepeatNet(nn.Module):
    def __init__(self, embedding_size, hidden_size, item_vocab_size):
        super(BlurRepeatNet, self).__init__()

        self.embedding_size = embedding_size
        self.hidden_size = hidden_size
        self.item_vocab_size = item_vocab_size

        # embedding layer with 0 padding
        ...
        self.mode = nn.Linear(hidden_size, 2)   # similar to a classifier
